...
<div id="log">
<a href="index.php">Home</a> | Oficina | <a href="doctype.php">Tipo de Documento</a> | <a href="../index.php">Logout</a>
</div>
<div id="formdesign">
<input type="text" name="filter" value="" id="filter" placeholder="Buscar Oficina" autocomplete="off" />
<a rel="facebox" href="addoffice.php" id="add">Añadir oficina</a>
</div>
<table cellspacing="0" cellpadding="2" id="resultTable">
<thead>
	<tr>
		<th width="70%"> Nombre de Oficina </th>
		<th width="30%"> Guardar </th>
	</tr>
</thead>
<tbody>
	<?php
	...
	<tr class="record">
		...
		<td><a href="#" id="<?php echo $row['id']; ?>" class="delbutton" title="Click To Delete">Eliminar</a></td>
	</tr>
	<?php
		}
	?>
...
//Built a url to send
var info = 'id=' + del_id;
 if(confirm("¿Esta seguro de que desea eliminar esta oficina?"))
		  {
