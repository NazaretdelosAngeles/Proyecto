...
<div id="log">
<a href="index.php">Home</a> | <a href="offices.php">Oficina</a> | Tipo de Documento | <a href="../index.php">Logout</a>
</div>
<div id="formdesign">
<input type="text" name="filter" value="" id="filter" placeholder="Buscar Documento" autocomplete="off" />
<a rel="facebox" href="adddoc.php" id="add">Añadir tipo de Documento</a>
</div>
