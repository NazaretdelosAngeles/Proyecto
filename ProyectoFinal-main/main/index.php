...
<div id="log">
Home | <a href="offices.php">Oficina</a> | <a href="doctype.php">Tipo de Documento</a> | <a href="../index.php">Logout</a>
</div>
<div id="formdesign">
<input type="text" name="filter" value="" id="filter" placeholder="Buscar Transacción" autocomplete="off" />
<a rel="facebox" href="add.php" id="add">Añadir Registro</a>
</div>
<table cellspacing="0" cellpadding="2" id="resultTable">
<thead>
	<tr>
		<th width="5%"> Fecha de Solicitud</th>
		<th width="7%"> Fecha de Entrega</th>
...
<tbody>
	...
	<tr class="record">
		...
		<td><a rel="facebox" href="editform.php?id=<?php echo $row['id']; ?>"> Editar </a> | <a href="#" id="<?php echo $row['id']; ?>" class="delbutton" title="Click To Delete">Eliminar</a></td>
	</tr>
	<?php
		}
	?>
